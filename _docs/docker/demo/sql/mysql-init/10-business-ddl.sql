...
CREATE TABLE `t_user` (
  ...
  `last_name` VARCHAR(255) DEFAULT NULL COMMENT '姓 (全角)',
  `first_name` VARCHAR(255) DEFAULT NULL COMMENT '名 (全角)',
  `last_name_kana` VARCHAR(255) DEFAULT NULL COMMENT '姓カナ (全角)',
  `first_name_kana` VARCHAR(255) DEFAULT NULL COMMENT '名カナ (全角)',
  `birth_date` VARCHAR(10) DEFAULT NULL COMMENT '生年月日 (yyyy/mm/dd)',
