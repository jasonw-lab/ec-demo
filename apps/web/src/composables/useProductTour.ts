...
const STEPS: StepDef[] = [
  {
    ...
    title: 'ログイン',
    description:
      'まずはログインしてください。デモでは Google ログインの利用を推奨します。メールアドレスまたは電話番号でのログインも利用できます。',
  },
  {
    index: 1,
    route: '/',
  ...
  },
  {
    ...
    title: '検索キーワード入力',
    description:
      '例として「iphone」を検索してみましょう。「次へ」を押すと iphone の検索結果画面へ移動します。',
  },
  {
    index: 3,
    route: '/search',
  ...
  },
  {
    ...
    title: 'カート確認',
    description:
      '追加した商品はカートで確認できます。このツアーではここまでを対象とし、購入前の主要導線を確認して完了します。',
  },
];
