  ...
  <div style="display: flex; min-height: 100vh; background: #f7f7f8">
    ...
    <div style="flex: 2; padding: 40px; background: #fff">
      ...
      <div style="margin-bottom: 32px">
        <div style="margin-bottom: 16px">
          <label style="display: block; font-size: 14px; color: #6b7280; margin-bottom: 4px"
            >支払い金額</label
          >
          <div style="font-size: 32px; font-weight: 700; color: #e60033">
        ...
        <div style="margin-bottom: 32px">
          <label style="display: block; font-size: 14px; color: #6b7280; margin-bottom: 4px"
            >オーダーID</label
          >
          <div style="font-size: 18px; font-weight: 600; color: #111827; font-family: monospace">
            {{ orderId }}
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div style="max-width: 400px; margin: 0 auto">
        ...
        <!-- ログインフィールド -->
        <form style="margin-bottom: 32px" @submit.prevent="handleLogin">
          ...
          >
            ...
            <a
              href="#"
              style="color: #fff; text-decoration: none; font-size: 14px; white-space: nowrap"
              >パスワードをお忘れの方</a
            >
          </div>
        </form>
        ...
        <!-- 外部アカウントログイン -->
        <div style="margin-bottom: 32px">
          <h3 style="margin: 0 0 16px 0; font-size: 18px; font-weight: 600; color: #fff">
            外部アカウントでログイン
          </h3>
          ...
          <div style="display: flex; flex-direction: column; gap: 12px">
            ...
            <button
              ...
              "
            >
              <span style="color: #666">SoftBank</span> /
              <span style="color: #666">ワイモバイル</span>
            </button>
          </div>
        </div>
      ...
      if (res.ok) {
        ...
        if (data.status === 'PAID') {
          ...
          router.push({
            ...
            query: { orderId: orderId.value, total: String(total.value) },
          });
          return;
...
function handleWsMessage(raw: string) {
  try {
    ...
    if (
      ...
      message.channelToken !== channelToken.value
    ) {
...
function finalizeFailure(message: Record<string, unknown>) {
  ...
  const code =
    typeof message?.code === 'string'
      ? message.code
      : typeof message?.paymentStatus === 'string'
...
onMounted(async () => {
  ...
  console.log('🚀 PaymentDetailView mounted with:', {
