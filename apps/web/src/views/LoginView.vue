    ...
    <div class="login-page">
      ...
      <main class="login-main">
        <section class="login-form-section" data-tour="login-form">
          ...
          <p class="note">
            <span class="link-text">利用規約</span>および<span class="link-text"
              >プライバシーポリシー</span
            >に同意の上、ログインへお進みください。このサイトはreCAPTCHAで保護されており、Googleのプライバシーポリシーと利用規約が適用されます。
          </p>

          <button class="help-link" type="button">ログインできない方はこちら ></button>
        </section>
        ...
        <section class="social-login-section">
          <button type="button" class="social-button apple" disabled @click="handleAppleLogin">
          ...
          <button type="button" class="social-button line" disabled @click="handleLineLogin">
            <span class="social-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path
          ...
          <button type="button" class="social-button passkey" disabled>
            <span class="social-icon">
              <svg
                width="20"
                height="20"
      ...
      <footer class="login-footer">
        ...
        <button class="register-button" type="button" @click="goToRegistration">会員登録</button>
      </footer>
    </div>
  </div>
</template>
