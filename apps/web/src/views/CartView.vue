  ...
  <div>
    ...
    <div v-else>
      ...
      >
        ...
        >
          <img
            :src="c.product.imageUrl || getImageUrl('/product.svg')"
            alt="商品画像"
            style="
              width: 80px;
              height: 80px;
          ...
          <div style="flex: 1">
            ...
            <div style="color: #ff6b6b; font-weight: 700; font-size: 18px">
              ¥ {{ Number(c.product.price).toLocaleString() }}
            </div>
          </div>
          <div style="display: flex; align-items: center; gap: 12px; margin-right: 16px">
            <div style="display: flex; align-items: center; gap: 8px">
              <button
                ...
                "
                @click="updateQuantity(c.productId, c.quantity - 1)"
              >
                -
              </button>
            ...
            <div style="text-align: right; min-width: 80px">
              <div style="font-weight: 700; color: #ff6b6b">
                ¥ {{ (Number(c.product.price) * c.quantity).toLocaleString() }}
              </div>
            </div>
          </div>
          <button
            style="background:none;border:1px solid #e5e7eb;border-radius:6px;padding:8px;cursor:pointer;color:#6b7280;hover:background:#f9fafb;"
            @click="remove(c.productId)"
          >
            <svg
              width="16"
              height="16"
...
const total = computed<number>(() =>
  cart.reduce((a, c) => a + Number(c.product.price) * c.quantity, 0)
);
